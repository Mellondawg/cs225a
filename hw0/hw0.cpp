...
int main() {
	...
	for( float d2 = 0.0; d2 <= 2.0; d2 = d2 + 0.1 ) { // increments of 30 degrees
		cout << "Using d2 (meters): " << endl;
		cout << d2 << endl; // Print the current q3 angle
		...
		*/
		robot->_q << 0.0, d2, 0.0; // Joint 1,2,3 Coordinates (radians, meters, radians)
		...
		*/
		...
		cout << robot->_M(0, 0) << endl; // m11
		cout << robot->_M(1, 1) << endl; // m22
		cout << robot->_M(2, 2) << endl; // m33
