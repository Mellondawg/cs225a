...
// - write
const std::string JOINT_TORQUES_COMMANDED_KEY = "sai2::cs225a::kuka_robot::actuators::fgc";
const std::string EE_POSITION_KEY = "sai2::cs225a::kuka_robot::sensors::x";
const std::string EE_VELOCITY_KEY = "sai2::cs225a::kuka_robot::sensors::dx";
const std::string EE_DESIRED_POSITION_KEY = "sai2::cs225a::kuka_robot::sensors::xd";
const std::string EE_DELTA_ANGLE_KEY = "sai2::cs225a::kuka_robot::sensors::dphi";
...
int main() {
	...
	const Vector3d ee_pos_in_link = Vector3d(0, 0, 0);
	...
	while (runloop) {
		...
		if(controller_number == QUESTION_2)
		{
			...
			q_upper << -165, -100, -165, -170, -165, 0; 
			q_lower << 165, 100, 165, -30, 165, 210; 
